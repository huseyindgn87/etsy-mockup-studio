...
const KINDS = new Set<DraftAssetKind>(["psd", "design", "own", "thumbnail"]);
 ...
 * or the drafts-list thumbnail. Body is the raw file bytes; `Content-Type`
 ...
 * back (design images, own photos, the thumbnail). Raw PSDs are never fetched
